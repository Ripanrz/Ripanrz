...
| :--- | :--- | :--- |
| 🍂 **Smart Composting ML** | Sistem IoT untuk prediksi kematangan kompos menggunakan Machine Learning TinyML. | Python, TensorFlow Lite, ESP32 |
| 🔋 **AI-HESS** | Hybrid Energy Storage System berbasis AI (Fuzzy/Neural Network) untuk efisiensi energi. | Embedded C++, MATLAB/Python AI |
| 📈 **Trading Scripts** | Indikator kustom dan strategi algoritma untuk analisis pasar di TradingView. | Pine Script v5 |
